...
| Quantified CINTAS design choices | Sweep feature budget, aggregation operator, decision-block length, score weighting, residual-score mixing, and fixed-point precision | `notebooks/exact_tcad_all_experiments.ipynb`, `configs/tcad_grid_full.json`, `results/notebook_run/tcad_ablation/tcad_ablation_summary.csv` |
